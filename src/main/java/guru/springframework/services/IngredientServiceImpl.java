...
//                .filter(ingredient -> ingredient.getId().equalsIgnoreCase(ingredientId))
//                .findFirst())
//                .filter(Optional::isPresent) // if we have a hit continue
//                .map(ingredient -> {
...
//                });
       ...
       //
        ...
        // Change to reactive type return, also change in this function return type to Mono
        // Ingredient service interface will be changed automatically by IntelliJ
